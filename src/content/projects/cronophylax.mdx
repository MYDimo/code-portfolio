...
description: "It is said that you need 10k hours to master something. But what do you use to keep track? Chronophylax is just that - a fancy time keeper app which has user tracking capabilities."
image:
  src: "../../assets/cronophylax-main-img.png"
  alt: "Screenshot of the homepage of Chronophylax."
pubDate: "2023-07-01"
tags: ["ReactJS", "firebase", "authentication"]
---

[![Netlify Status](https://api.netlify.com/api/v1/badges/730bdb01-d7e1-4f64-a8a8-e713fd0ea221/deploy-status)](https://app.netlify.com/sites/chronophylax/deploys)
